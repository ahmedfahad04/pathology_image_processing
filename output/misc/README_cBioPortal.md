...
python scripts/analysis/fetch_cbioportal_data.py --image-dir image/ --outdir data
python scripts/analysis/fetch_cbioportal_data.py --image-dir image/ --study auto --gene FGFR3
```
